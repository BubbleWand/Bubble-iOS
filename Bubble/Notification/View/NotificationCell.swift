...
class NotificationCell: UITableViewCell{
    ...
    let title: UILabel = {
        let title = UILabel()
        title.font = UIFont(name: "AvenirNext-Light", size: 20)
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?){
        ...
        groupImage.widthAnchor.constraint(equalTo: stackView.widthAnchor, multiplier: 0.12).isActive = true
...
//        setUpTitle()
    ...
    func setCellContents(group: Notification2){
