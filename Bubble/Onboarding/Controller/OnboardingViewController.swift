...
//  Bubble
//
//  Created by Jessica Trinh on 6/2/20.
...
class OnboardingViewController: UIViewController, UIScrollViewDelegate{
    ...
    func setCustomViews(){
        firstView = OnboardingView(color: UIColor(red:1.00, green:0.59, blue:0.40, alpha:1.0), image: UIImage(named: "placeholder")!, headerText: "A", bodyText: "Description 1")
        secondView = OnboardingView(color: UIColor(red:0.91, green:0.36, blue:0.62, alpha:1.0), image: UIImage(named: "placeholder")!, headerText: "B", bodyText: "Description 2")
        thirdView = OnboardingView(color: UIColor(red:0.44, green:0.40, blue:1.00, alpha:1.0), image: UIImage(named: "placeholder")!, headerText: "C..", bodyText: "Description 3!", isLastPage: true)
